<script lang="ts">
    ...
    $: totalActualExpenses = $budgetData.expenses
      .filter((exp: Expense) => exp.selected)
      .reduce(
        (sum, exp) => sum + (exp.actual !== undefined && exp.actual > 0 ? exp.actual : exp.planned),
        0
      );
  ...
  <div class="container">
    ...
    <div class="summary">
      ...
      <p>Total Planned Expenses (Selected): <strong>{totalPlannedExpenses}</strong></p>
      <p>Total Actual Expenses (Selected): <strong>{totalActualExpenses}</strong></p>
          ...
          <div class="expense-row">
            ...
            <div>
              ...
              <input
                ...
                type="number"
                min="0"
                value={expense.actual !== undefined && expense.actual > 0 ? expense.actual : expense.planned}
